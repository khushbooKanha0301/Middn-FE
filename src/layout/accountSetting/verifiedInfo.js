        ...
        <Card.Body>
          ...
          <ul className="verified">
            <li>
              ...
              {((!userData.fname && !userData.lname && !userData.email && !userData.phone) || 
              (userData.fname === undefined && userData.lname === undefined && 
                userData.email === undefined && userData.phone === undefined) ? 
